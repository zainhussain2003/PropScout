...
| Item                                                                    | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ----------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Kijiji geocoding: gate on Mapbox relevance, re-geocode the bad rows** | Found on D-117's live run. The Kijiji scraper geocodes "title, neighbourhood, City of Toronto"; neighbourhood names Mapbox does not know ("South Cedarbrae", "Bendale-Glen Andrew") land in the wrong postal code — Scarborough houses in M4S — and become 5 km "comps" for midtown. Fix in `services/scrapers`: geocode the neighbourhood + city only (strip the title), drop results below a relevance threshold, and re-geocode the existing 4.7k Kijiji rows (a data write through the scraper's own service, no schema change). Better still, read the ad page's own coordinates. |
