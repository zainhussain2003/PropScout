...
| ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| **ScraperAPI credits — exhausted 2026-09-20** — _URL analysis is down until this is done_ | `https://api.scraperapi.com/account` reports `requestCount 1030 / requestLimit 1000, creditsLeft 0`, `payAsYouGoEnabled false`; the cycle resets 2026-10-08. Every Realtor.ca URL now returns 403 through the proxy and the app answers "Could not read that listing — enter details manually". Enable overages or upgrade on the ScraperAPI billing page. Premium requests cost more than one credit each and the scraper retries four times per listing, so ~250 URL analyses a month is the ceiling on the 1,000-credit plan. The nightly comps job does not use ScraperAPI and is unaffected. | Both test listings failed on 2026-09-20; 1210-25 Holly St had scraped minutes earlier.                              |
