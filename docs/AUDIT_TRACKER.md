...
| Item                                               | Notes                                                                                                                                                                                                                                                                                                                                                            |
| -------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Landing 380px horizontal overflow** ✅ `2f5f9de` | Was `scrollWidth` 743px at 380px. Fixed 2026-07-05: nav collapses to wordmark + toggle (`.nav-links`≤820px, `.lp-nav-cta`≤640px); hero / `#sunscout` / `#faq` / pricing / footer grids collapse to single column; bottom CTA row wraps. Verified in a 380px iframe: scrollWidth 369<380, zero unclipped overflow at 360/380/414px. Guards in `landing.test.tsx`. |
