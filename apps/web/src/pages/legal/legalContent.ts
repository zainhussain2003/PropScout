...
<p>We will not use your data to train external machine-learning models. When a listing description needs structured flag extraction, its marketing text may be sent to the Anthropic Claude API without your account identity. Report verdict prose is generated deterministically by PropScout and is not sent to a language model.</p>`,
  },
  {
    id: 'share',
...
<p>If you are using PropScout on behalf of a company or organization, you confirm that you have authority to bind that entity to these Terms.</p>`,
  },
  {
    id: 'service',
    title: 'The service',
    body: `<p>PropScout is software that analyzes Canadian real estate listings. You paste a URL; we return a report containing scraped property data, comparable rental and sale data, calculated investment metrics, neighbourhood data, sun-path analysis, risk flags, and a deterministic written verdict assembled from validated inputs.</p>
...
<p>PropScout is an information tool. The reports, scores, verdicts, and calculation outputs we produce are <em>not</em> financial, legal, tax, real estate, or mortgage advice. They are estimates and analyses based on data sourced from public listings, public datasets, and our scraped rental comparables database.</p>
...
<p>PropScout is not a substitute for any of these. We do not guarantee the accuracy, completeness, or timeliness of any data, calculation, structured flag, or verdict text we display.</p>`,
  },
  {
    id: 'account',
...
<p>If we detect abuse, we may suspend or terminate your account without notice.</p>`,
  },
  {
    ...
    body: `<p>PropScout's software, design, calculation engine, deal-score formula, and extraction rules are our intellectual property. The PropScout name, logo, and "Scout-Mark" are trademarks.</p>
