...
│       ├── lib/exitScenarios.ts + exitScenarios.test.ts   # Stress / flat / conservative / base exit after selling costs and the balance owed; IRR on the dated stream (D-110, D-123)
│       ├── lib/irr.ts + irr.test.ts                       # NPV and IRR by bisection (D-123)
│       ├── lib/rateProvenance.ts + rateProvenance.test.ts # The sentence under the mortgage-rate slider, from the ledger's rate row (D-123)
